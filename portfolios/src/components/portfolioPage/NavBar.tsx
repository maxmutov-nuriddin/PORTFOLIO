        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className="navbar-text">
            <div className="social-icon">
              ...
              <a className="social-icon-link" href="#"><i className="bi fs-3 m-0 text-warning bi-telegram"></i></a>
              <a className="social-icon-link" href="#"><i className="bi fs-3 m-0 text-warning bi-github"></i></a>
            </div>
          </span>
        </Navbar.Collapse>
      </Navbar>
